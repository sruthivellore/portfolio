...
const KB = [
  ...
  { id: 'hireme', keys: ['why should i hire you', 'why hire you', 'hire you', 'why should we hire', 'sell yourself', 'pitch', 'convince me', 'value'],
    a: "<b>Why hire me:</b> I cover ground that usually takes two or three people. I've built multi-threaded backend services, real-time call and data pipelines, cloud infrastructure, and production LLM systems, and I own each of them from design through CI/CD to deployment. Three things I'd point at: I built a PBX call-queue platform with a signed webhook event contract and proved it with live call testing; I shipped tenant-scoped RBAC enforced per action across the backend; and I built an AI pipeline that cut feature setup from hours to about 5 minutes. I ship, I measure, and I stay for the operational part." },

  { id: 'circle', keys: ['circle', 'current', 'now', 'devassist', 'telephony', 'pbx', 'rbac'],
    a: "<b>Circle Software (Apr 2026 to present):</b> Built the PBX call-queue platform, including queue and agent-status APIs and a signed webhook contract covering the full call lifecycle, with abandon and missed-call detection validated by live call testing. Shipped tenant-scoped <b>RBAC</b> with a per-verb permission matrix powering the admin Control Center, plus phone-number provisioning and OAuth 2.0 email integrations (Microsoft 365, Google Workspace, Gmail). Also built <b>DevAssist</b>, a GitLab pipeline turning a Jira ticket and Figma design into conformant code, cutting feature setup from hours to about 5 minutes." },
...
const SUGGEST = ['whoami', 'why should I hire you', 'circle software', 'ai', 'backend', 'frontend', 'projects', 'contact']
...
function answer(q) {
  ...
  if (query === 'help' || query === '?' || query === 'commands')
    return "Ask me about Sruthi. Try: <b>whoami</b>, <b>why should I hire you</b>, <b>circle software</b>, <b>ai</b>, <b>backend</b>, <b>frontend</b>, <b>cloud</b>, <b>skills</b>, <b>experience</b>, <b>projects</b>, <b>education</b>, <b>awards</b>, <b>contact</b>. Commands: <b>ls</b>, <b>clear</b>."
  if (query === 'ls')
